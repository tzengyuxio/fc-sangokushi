...
所有 Head 都佔用 24 tiles 的空間 (384 bytes)。部分 Head 使用重複 tile 或全黑 tile 填充。

| Head | ROM 偏移 | Template | Pattern |
|-------|----------|----------|---------|
| H00 | 0x1C014 | T00 | P1 |
| H01 | 0x1C194 | T01 | P1 |
| H02 | 0x1C314 | T02 | P1 |
...
**注意:** 20 個 Head (H00-H19) 與 20 個 Template (T00-T19) 1:1 對應。每個 Head 佔 24 tiles × 16 bytes = 384 bytes。
