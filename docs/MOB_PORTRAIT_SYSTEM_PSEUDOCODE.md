...
// Group → Template 映射 (注意: T04 未使用)
GROUP_TO_TEMPLATE = {
    0: 0, 1: 1, 2: 2, 3: 3,      // G00-G03 直接對應
    4: 5, 5: 6, 6: 7, 7: 8,      // G04+ 跳過 T04
    8: 9, 9: 10, 10: 11,
    11: 12, 12: 13, 13: 14,
...
2. **Template 排列表**: 20 個 Template 於 0x1ED14，G04+ 跳過 T04
3. **8 種 Pattern 類型**: 根據 tile 重複方式分類
4. **Group-Template-Pattern 映射**: 完整對照表已建立

## 待解決問題

1. **portrait_id → Group 映射**: 174 個大眾臉頭像如何對應到 19 個 Group？
