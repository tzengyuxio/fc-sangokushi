...
### 以驗證索引表（按照 PID 排序，前五位）

| P_ID | 武將 | char_idx | Cat | Head | Eye | Nose | Mouth |
|------|------|----------|-----|------|-----|------|-------|
| P081 | 周泰 | 39 | 3 | 0 | 2 | 3 | 1 |
| P082 | 孫翊 | 40 | 3 | 0 | 3 | 4 | 3 |
| P083 | 孫瑜 | 41 | 0 | 1 | 2 | 1 | 2 |
| P084 | 孫桓 | 42 | 3 | 0 | 3 | 0 | 0 |
| P085 | 曹豹 | 45 | 2 | 0 | 1 | 3 | 1 |
